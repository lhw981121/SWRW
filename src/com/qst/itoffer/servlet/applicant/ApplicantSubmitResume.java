package com.qst.itoffer.servlet.applicant;
...
public class ApplicantSubmitResume extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("basicInfo_id")==null||request.getParameter("realName")==null||request.getParameter("birthday")==null||
			...
			request.getParameter("project_job")==null||request.getParameter("project_period_start")==null||request.getParameter("project_period_end")==null||
			request.getParameter("project_desc")==null||request.getParameter("work_title")==null||request.getParameter("department")==null||
			request.getParameter("work_period_start")==null||request.getParameter("work_period_end")==null) {
		...
		Date graduation_date = COMUtil.strToDate(request.getParameter("graduation_date"));
		...
		String project_period_start = request.getParameter("project_period_start");
		String project_period_end = request.getParameter("project_period_end");
		String project_desc = request.getParameter("project_desc");
		String work_title = request.getParameter("work_title");
		String department = request.getParameter("department");
		String work_period_start = request.getParameter("work_period_start");
		String work_period_end = request.getParameter("work_period_end");
		
		
        boolean isOK = false;
        
        String project_period = project_period_start.length()==0?"":project_period_start+"_"+project_period_end;
        String work_period = work_period_start.length()==0?"":work_period_start+"_"+work_period_end;
