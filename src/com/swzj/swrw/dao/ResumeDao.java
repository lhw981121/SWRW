...
public class ResumeDao {
	...
	*/
	...
	public static boolean updateResume(String basicInfo_id,String realName,Date birthday,String email,String gender,String job_experience,
									...
									String profession,String graduation_date,String education_degree,String project_name,String project_job,
		...
		try{
			...
			if(graduation_date.length()==0)	pstmt.setNull(2, Types.VARCHAR);	else	pstmt.setString(2,graduation_date);
			if(education_degree.length()==0)pstmt.setNull(3, Types.VARCHAR);	else	pstmt.setString(3,education_degree);
			...
			if(project_job.length()==0)		pstmt.setNull(3, Types.VARCHAR);	else	pstmt.setString(3,project_job);
			...
			if(work_title.length()==0)		pstmt.setNull(3, Types.VARCHAR);	else	pstmt.setString(3,work_title);
