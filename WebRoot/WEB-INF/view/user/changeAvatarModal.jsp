	...
	$.ajax({
		...
		success:function(result) {
			...
			if(r.isOK==true){//头像上传成功
				...
				$('#user_avatar_mycenter').attr('src', '/SWRW/public/images/user/avatar/'+${user.getID()}+'.jpg?t='+Math.random());
				$('#user_avatar_header').attr('src', '/SWRW/public/images/user/avatar/'+${user.getID()}+'.jpg?t='+Math.random());
				$('#changeAvatarModal').modal('hide');
			}else{//头像上传失败
