...
<div class="main-content">
	<!-- 审核未通过企业 -->
	<div class="panel" id="unapprovedCompanyPanel">
		<div class="panel-heading">
			<h3 class="panel-title">审核未通过企业资质认证</h3>
		</div>
		<div class="panel-heading">
		...
		<div class="panel-body">
			<table class="table table-hover">
				...
				<tbody id="unapprovedCompanyData">
				</tbody>
			</table>
		</div>
...
<!-- 自定义脚本 -->
<script src="/SWRW/public/js/admin/company/unapprovedCompany.js"></script>
