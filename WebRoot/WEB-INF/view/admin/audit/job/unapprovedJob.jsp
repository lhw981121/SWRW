...
<div class="main-content">
	<!-- 待审核企业 -->
	<div class="panel" id="unapprovedJobPanel">
		<div class="panel-heading">
			<h3 class="panel-title">审核未通过职位</h3>
		</div>
		<div class="panel-heading">
...
<!-- 自定义脚本 -->
<script src="/SWRW/public/js/admin/job/unapprovedJob.js"></script>
